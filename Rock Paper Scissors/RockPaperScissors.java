...
public class RockPaperScissors {
	...
	public static void main(String[] args) {
		...
		while(player1.getWins() < getWinningScore() || player2.getWins() < getWinningScore())
		{
			player1.makeChoice();
			player2.makeChoice();
	...
	private static GamePlayer compareChoices(GamePlayer player1, GamePlayer player2) {
		...
		else if((player1.getChoice() == GamePlayer.ROCK && player2.getChoice() == GamePlayer.SCISSORS) ||
				(player1.getChoice() == GamePlayer.SCISSORS && player2.getChoice() == GamePlayer.PAPER) ||
				(player1.getChoice() == GamePlayer.PAPER && player2.getChoice() == GamePlayer.ROCK))
		{
			return player1;
		}
		return player2;
